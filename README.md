...
| `WHISPER_MODEL_SIZE` | base | Whisper 模型 / Whisper model (tiny/base/small/medium/large-v3) |
| `SPEECH_THRESHOLD` | 0.5 | 语音检测阈值 (0-1) / Speech detection threshold |
| `HOTKEY_SELECT_REGION` | ctrl+alt+2 | 选择区域热键 / Select region hotkey |
| `HOTKEY_WINDOW_SELECTION` | ctrl+alt+3 | 选择窗口热键 / Select window hotkey |
| `HOTKEY_TOGGLE_OVERLAY` | ctrl+alt+4 | 显示/隐藏浮动窗口热键 / Toggle overlay hotkey |
| `HOTKEY_SPEECH_MODE` | ctrl+alt+5 | 语音翻译热键 / Speech translation hotkey |
